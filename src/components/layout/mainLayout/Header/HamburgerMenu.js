...
const HamburgerMenu = ({ navItems }) => {
  ...
  return (
    <div className="md:hidden">
      ...
      <div
        ref={menuRef}
        className={`min-h-screen fixed top-0 left-0 max-w-[230px] w-full bg-white z-50 flex flex-col gap-4 transition p-4 pt-10 ${
      ...
      <div
        ...
        className={`min-h-screen fixed top-0 left-0 w-full bg-black/10 transition ${
