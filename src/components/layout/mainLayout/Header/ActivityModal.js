  ...
  return (
    ...
    >
      ...
      <div className="px-5 flex-between-center my-4">
        ...
        <span className="bg-green-900 text-white text-xs p-1 font-semibold rounded">14h, 17min</span>
      </div>
...
const ActivityElements = ({ value }) => (
  <div className="border rounded-lg flex-between-center px-3 py-2">
    ...
    <div className="flex-start-center gap-3">
      <p className={` flex-start-center ${value.extraAmount > 0 ? "text-green-900" : "text-red-900"}`}>
